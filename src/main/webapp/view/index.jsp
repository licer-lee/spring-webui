...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
							...
							<ul class="dropdown-menu">
								...
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${ctx}/static/dist/img/user3-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${ctx}/static/dist/img/user4-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="${ctx}/logout" class="btn btn-default btn-flat">Sign
											out</a>
									</div>
								</li>
							</ul></li>
						...
						<li class=" treeview">
							...
							<ul class="treeview-menu">
								<c:if test="${fn:length(m.child) >0 }">
									<c:forEach items="${m.child }" var="mChild">
										<li class=""><a href="${ctx}/${mChild.mUrl }"
											target="main-content"><i class="fa fa-circle-o"></i>
												${mChild.mName }</a></li>
									</c:forEach>
								</c:if>
							</ul>
		...
		<div class="content-wrapper">
			...
			<!-- ${ctx }/dashboard -->
			<iframe name="main-content" id="main-content" scrolling="auto"
				frameBorder="0" src="${ctx }/dashboard" onload="iFrameHeight()"
